...
export function AboutView({ setView }: { ctx: AppContext; setView: (v: View) => void }) {
  return (
    <div className="page">
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: 10, marginTop: 18 }}>
            <button className="btn btn-primary btn-lg" onClick={() => setView('hub')}>
              See what&rsquo;s available <Icons.Arrow size={14} />
            </button>
      ...
      <div style={{ marginTop: 36, padding: '28px 28px', background: 'var(--paper)', border: '1px solid var(--line)', borderRadius: 'var(--radius-lg)' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32, alignItems: 'center' }}>
          <div>
            <div style={{ fontSize: 12, color: 'var(--mute)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
              Open questions for partner interviews
            </div>
            ...
            <ul style={{ paddingLeft: 18, color: 'var(--ink-2)', margin: 0 }}>
              ...
              <li>Right time-window for posting? Is &ldquo;30 min before close&rdquo; realistic?</li>
          ...
          <div style={{ background: 'var(--cream)', padding: 24, borderRadius: 'var(--radius)', border: '1px dashed var(--line-2)', fontSize: 13.5, color: 'var(--ink-2)', lineHeight: 1.6 }}>
            ...
            4.&nbsp; Walk through &ldquo;Post surplus&rdquo; — show how fast the 3-step form is.<br />
            5.&nbsp; Land on impact stats — &ldquo;this is what they&rsquo;d get back&rdquo;.
          </div>
        </div>
      </div>
    </div>
